...
public class ForecastConditionAdapter {
  ...
  @FromJson
  public ForecastCondition forecastConditionFromJson(ForecastConditionJson forecastConditionJson) {

    FctTime fcTTime = forecastConditionJson.getFcTTime();
    LocalDateTime dateTime = LocalDateTime.of(fcTTime.getYear(), fcTTime.getMon(),fcTTime.getMday(), fcTTime.getHour(), fcTTime.getMin());
    String displayTime = String.format("%s:%s %s", fcTTime.getHour(), fcTTime.getMin(),fcTTime.getAmpm());
